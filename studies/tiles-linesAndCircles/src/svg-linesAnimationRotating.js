...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (SVG.supported) {
    ...
    requestAnimationFrame(function() {
      ...
      var baseBackGround = draw.rect(100, 150).attr({fill:'rgba(38,117,177, .3)'});
      ...
      var rectRotatedStripes1 = draw.circle(150).addClass('rotate').attr({ fill: patternVerticalStripes }).move(-25,-25).rotate(216.5);
      var rectRotatedStripes2 = draw.circle(150).addClass('rotate').attr({ fill: patternVerticalStripes }).move(-25,-25).rotate(60.5);
      //TODO: ANIMATE rectRotatedStripes2 rotate( variable )
      ...
      //@challenge: place rect in center of tile, which slowly rotates from center transform-origin.
        ...
        groupTile
          .add(baseBackGround)
          .add(rectRotatedStripes1).maskWith(draw.rect(100,75).fill('#ffffff'))
          .add(rectRotatedStripes2).maskWith(draw.rect(100,75).fill('#ffffff'))
          ;
